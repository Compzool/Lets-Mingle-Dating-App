...
import 'package:mingle/bloc/message/bloc.dart';
import 'package:mingle/repositories/messagesRepository.dart';
import 'package:mingle/ui/widgets/chat.dart';
    ...
    return BlocBuilder<MessageBloc, MessageState>(
      ...
      builder: (BuildContext context,MessageState state){
          if(state is MessageInitialState){
            _messageBloc.add(ChatStreamEvent(widget.userId));
          }
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context,int index ){
                        return ChatWidget(
                          ...
                          selectedUserId: snapshot.data.documents[index].documentID,
                        );
                      },
                    );
                  }
